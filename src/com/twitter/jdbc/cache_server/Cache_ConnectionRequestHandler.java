...
public class Cache_ConnectionRequestHandler implements Runnable{
		private Socket _socket = null;
		private PrintWriter _out = null;
		private BufferedReader _in = null;
 
		public Cache_ConnectionRequestHandler(Socket socket) {
			_socket = socket;
		}
		...
		public void run() {
			...
			try {
				...
				Cache_BusinessLogic businessLogic = new Cache_BusinessLogic();
